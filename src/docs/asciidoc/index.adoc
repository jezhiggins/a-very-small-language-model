...
> node bin/chimera.js 2
 ...
 In the exuberance of my acquaintances are already under such
a conclusion of all that belonged to this kind was done away
much of their inattention to what was going to be not quite so
strongly anywhere else.  Quack!  More than once in a half km
of fibre to.  And you've just stopped me from venturing out
unless the weather was exceptionally genial, and having
wikipedia pages and what they call delirium, I can recall
nothing worse.
