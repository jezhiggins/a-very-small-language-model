...
[NOTE.speaker]
--
I still haven't gone off and downloaded large chunks of the public internet. Here, I've used the text of Pride and Prejudice. I've never read it, but my computer has read it for me, and produced these little extracts.

I still haven't gone off and downloaded large chunks of the public internet. Here, I've used the text of Pride and Prejudice. I've never read it, but my computer has read it for me, and produced these little extracts. I think I've got the gist.
...
We've taken another big step up in word count - up to 650 thousand words - five times as many as Pride and Prejudice and getting on for 15 times as many words as in my toot archive. But we've almost changed another dimension.
