...
I'm not quite sure where this came from, but I think it's because I'd just sat down to watch a FIH ProLeague hockey match, so I was trying to do it before the end of the game.
