...
For my purposes I was rather less formal, and used a text corpus I happened to have to hand.
--
...
[NOTE.speaker]
--
Here it is. 2384 scintillating lines, containing 46576 individual words.
